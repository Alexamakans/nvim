...
ln -sT "$PWD/nvim-cpp" "${XDG_CONFIG_HOME:-$HOME/.config}/nvim-cpp"
ln -sT "$PWD/nvim-golang" "${XDG_CONFIG_HOME:-$HOME/.config}/nvim-golang"
...
NVIM_APPNAME=nvim-cpp nvim
NVIM_APPNAME=nvim-golang nvim
